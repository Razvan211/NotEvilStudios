...
function AboutUs() {
	return (
		<div>
            ...
            Not Evil Studios is an indie game development studio with 7 team members based 
            in the Southwest of England. At the moment, our in progress projects include Fling, 
            a 2D physics based mobile game, as well as Cat-Astrophe, a 3D PC game where Cats 
            fight one another with Fishy weapons.
				</p>
			</div>
